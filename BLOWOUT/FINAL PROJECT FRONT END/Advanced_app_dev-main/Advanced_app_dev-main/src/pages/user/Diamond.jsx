    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const formData = {
                ...
                events: selectedCheckboxes.join(', '), // Convert array to string
    ...
    return (
        <div className="package">
            ...
            <form className="package-form" onSubmit={handleSubmit}>
                ...
                <Box sx={{ width: 500 }}>
                    <Slider name="members" size="small" defaultValue={70} min={50} max={100} aria-label="Small" valueLabelDisplay="on" />
                </Box>
                <Box>
