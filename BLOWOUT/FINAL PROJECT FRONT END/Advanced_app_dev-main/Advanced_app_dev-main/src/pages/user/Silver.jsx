    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const formData = {
                ...
                members: parseInt(e.target.members.value),
                venue: e.target.venue.value,
                events: selectedCheckboxes.join(','),
    ...
    return (
        <div className="package">
            ...
            <form className="package-form" onSubmit={handleSubmit}>
                <TextField label="Name" type="text" sx={{ width: 500 }} required variant="standard" />
                <label>No of members</label>
                <Box sx={{ width: 500 }}>
                    <Slider size="small" defaultValue={8} min={2} max={10} aria-label="Small" valueLabelDisplay="on" />
                </Box>
                <Box>
                    <FormControl required variant="standard" sx={{ minWidth: 350 }}>
                        <InputLabel id="venue-label">Venue</InputLabel>
                        <Select labelId="venue-label" id="venue" label="Venue">
                ...
                <Box>
                    <FormControl required sx={{ minWidth: 350 }} variant="standard">
                        ...
                        <Select labelId="food-label" id="food" label="Food">
